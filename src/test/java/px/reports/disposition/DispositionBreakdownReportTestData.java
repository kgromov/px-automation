 ...
 */
public class DispositionBreakdownReportTestData extends ReportTestData {
    {
        durationDays = 2;
        startMonthOffset = 2;
    }
    ...
    private JSONArray itemsByBuyerInstanceGUID;
    private JSONArray itemsByPublisherInstanceGUID;
    private JSONArray itemsByVertical;
    private JSONArray itemsByAllFilters;
    // sub instances
    private List<ObjectIdentityData> buyerCampaigns;  // /api/lightModel/buyerinstancesbyparent?parent=<buyer_guid>
    ...
    // mapping
    private static final String REACH_TIME_KEY = "averageReachTime";
    ...
    public DispositionBreakdownReportTestData() {
        this(false);
    }

    public DispositionBreakdownReportTestData(boolean isInstances) {
        super(isInstances);
        setInstanceGroup("dispositionBreakdown/report");
        setSorting("disposition", "desc");
        setDateRanges();
...
//            this.publisher = ObjectIdentityData.getAnyObjectFromList(dataProvider.getCreatedInstancesData("publishers"));
            ...
            this.itemsByBuyerGUID = DispositionTestData.updateWithReachTime(itemsByBuyerGUID, REACH_TIME_KEY);
            ...
            this.itemsByPublisherGUID = DispositionTestData.updateWithReachTime(itemsByPublisherGUID, REACH_TIME_KEY);
            ...
            if (hasBuyerInstances()) {
                ...
                this.itemsByBuyerInstanceGUID = DispositionTestData.updateWithReachTime(itemsByBuyerInstanceGUID, REACH_TIME_KEY);
            }
            ...
            if (hasPublisherInstances()) {
                ...
                this.itemsByPublisherInstanceGUID = DispositionTestData.updateWithReachTime(itemsByPublisherInstanceGUID, REACH_TIME_KEY);
            }
            ...
            this.itemsByVertical = DispositionTestData.updateWithReachTime(itemsByVertical, REACH_TIME_KEY);
            //  rows in table after all filters
            List<String> paramsKeys = new ArrayList<>(Arrays.asList(PUBLISHER_FILTER, BUYER_FILTER, VERTICAL_FILTER, "FromPeriod", "ToPeriod"));
            ...
            List<String> paramsValues = new ArrayList<>(Arrays.asList(publisher.getGuid(), buyer.getGuid(), vertical, fromPeriod, toPeriod));
            ...
            this.itemsByAllFilters = DispositionTestData.updateWithReachTime(itemsByAllFilters, REACH_TIME_KEY);
            // update all rows
            this.allRowsArray = DispositionTestData.updateWithReachTime(allRowsArray, REACH_TIME_KEY);
            // set filter values map
            this.resetData = new DispositionBreakdownReportTestData.FiltersResetData();
    ...
    protected void setHeadersURL() {
        this.headersURL = new RequestedURL.Builder()
                .withRelativeURL("api/dispositionBreakdown/report")
                .build().getRequestedURL();
    }
    ...
    public String toString() {
        ...
        return super.toString() +
                "\nDispositionBreakdownReportTestData{" +
                instanceDetails +
                '}';
    }
    ...
    private class FiltersResetData extends AbstractFiltersResetData {
        ...
        public void resetFilter() {
            ...
            this.itemsByFiltersCombination = DispositionTestData.updateWithReachTime(itemsByFiltersCombination, REACH_TIME_KEY);
        }
    }
}
