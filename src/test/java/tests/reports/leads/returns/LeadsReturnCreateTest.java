 ...
 */
public class LeadsReturnCreateTest extends LoginTest {

    // as verification - 1 row added to single lead report
    @Test(dataProvider = "returnLeadWithPositiveData", dataProviderClass = LeadDataProvider.class)
...
//        leadReturnReportPage.checkSingleLeadReturn(testData);
    ...
    @Test(dataProvider = "returnLeadWithNegativeData", dataProviderClass = LeadDataProvider.class)
